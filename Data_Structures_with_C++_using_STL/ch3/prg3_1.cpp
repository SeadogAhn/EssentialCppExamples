...
#include "../include/d_search.h"	// generic sequential and binary searches
#include "../include/d_sort.h"		// generic selection sort
#include "../include/d_random.h"	// random number generation
#include "../include/d_timer.h"		// time events
